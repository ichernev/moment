...
exports.weekYear = {
    ...
    "iso weekday": function (test) {
        ...
        for (i = 0; i < 7; ++i) {
            moment.defineLocale('dow:' + i + ',doy: 6', {week: {dow: i, doy: 6}}, true);
    ...
    "weekday first day of week Monday (dow 1)": function (test) {
        ...
        moment.defineLocale('dow: 1,doy: 6', {week: {dow: 1, doy: 6}}, true);
    ...
    "weekday first day of week Tuesday (dow 2)": function (test) {
        ...
        moment.defineLocale('dow: 2,doy: 6', {week: {dow: 2, doy: 6}}, true);
    ...
    "weekday first day of week Wednesday (dow 3)": function (test) {
        ...
        moment.defineLocale('dow: 3,doy: 6', {week: {dow: 3, doy: 6}}, true);
    ...
    "weekday first day of week Thursday (dow 4)": function (test) {
        ...
        moment.defineLocale('dow: 4,doy: 6', {week: {dow: 4, doy: 6}}, true);
    ...
    "weekday first day of week Friday (dow 5)": function (test) {
        ...
        moment.defineLocale('dow: 5,doy: 6', {week: {dow: 5, doy: 6}}, true);
    ...
    "weekday first day of week Saturday (dow 6)": function (test) {
        ...
        moment.defineLocale('dow: 6,doy: 6', {week: {dow: 6, doy: 6}}, true);

...
exports.weeksInYear = {
    ...
    "weeksInYear doy/dow = 1/4": function (test) {
        moment.defineLocale('1/4', {week: {dow: 1, doy: 4}}, true);
    ...
    "weeksInYear doy/dow = 6/12": function (test) {
        moment.defineLocale('6/12', {week: {dow: 6, doy: 12}}, true);
    ...
    "weeksInYear doy/dow = 1/7": function (test) {
        moment.defineLocale('1/7', {week: {dow: 1, doy: 7}}, true);
    ...
    "weeksInYear doy/dow = 0/6": function (test) {
        moment.defineLocale('0/6', {week: {dow: 0, doy: 6}}, true);
